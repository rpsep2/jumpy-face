...
function init(){
    ...
    function face_jump(event) {
        ...
        // todo: work out final bottom left position & animation duration based on height will be at top of jump multipled by half a jump_x
